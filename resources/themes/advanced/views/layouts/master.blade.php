...
<html lang="{{ app()->getLocale() }}">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('themes/advanced/assets/css/advanced.css') }}" />
        <link rel="stylesheet" href="{{ asset('themes/advanced/assets/css/bootstrap.min.css') }}" />
        <link rel="stylesheet" href="{{ asset('themes/advanced/assets/css/google-font.css') }}" />

        @if (core()->getCurrentLocale()->direction == 'rtl')
            <link href="{{ asset('themes/advanced/assets/css/bootstrap-flipped.css') }}" rel="stylesheet">
        @endif

        @if ($favicon = core()->getCurrentChannel()->favicon_url)
            <link rel="icon" sizes="16x16" href="{{ $favicon }}" />
        @else
            <link rel="icon" sizes="16x16" href="{{ asset('/themes/advanced/assets/images/static/v-icon.png') }}" />
        @endif

        <script
            type="text/javascript"
            src="{{ asset('themes/advanced/assets/js/jquery.min.js') }}">
        </script>

        <script
            type="text/javascript"
            baseUrl="{{ url()->to('/') }}"
            src="{{ asset('themes/advanced/assets/js/advanced.js') }}">
        </script>

        <script
            type="text/javascript"
            src="{{ asset('themes/advanced/assets/js/jquery.ez-plus.js') }}">
        </script>
